...
namespace Microsoft.GoCloudOnboardingBot
{
    ...
    ///  - See <see cref="ClientTriageBot"/> constructor for how that is injected.
    ///  - See the Startup.cs file for more details on creating the Singleton that gets
    ///    injected into the constructor.
    /// </summary>
    public class ClientTriageBotAccessors
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ClientTriageBotAccessors"/> class.
        ...
        public ClientTriageBotAccessors(ConversationState conversationState, UserState userState)
        {
